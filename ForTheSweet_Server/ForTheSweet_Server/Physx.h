...
public:
	...
	PxRigidStatic* getRotateBoxTrigger(PxVec3& t, PxVec3& ro, PxVec3 size, int trigger_type, int order);	// 빼빼로 세팅

	PxRigidStatic* getSphereTrigger(PxVec3& t, PxReal rad, int trigger_type, int order);	// 롤리팝, 츄파춥스 세팅

	PxRigidDynamic* getBox(PxVec3& t, PxVec3 size);						// 맵세팅
