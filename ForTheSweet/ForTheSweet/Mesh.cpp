...
//{
//	m_pScene = aiImportFile(fileName.c_str(), aiProcess_JoinIdenticalVertices |        // µø¿œ«— ≤¿¡ˆ¡° ∞·«’, ¿Œµ¶ΩÃ √÷¿˚»≠
//				aiProcess_ValidateDataStructure |        // ∑Œ¥ı¿« √‚∑¬¿ª ∞À¡ı
//				aiProcess_ImproveCacheLocality |        // √‚∑¬ ¡§¡°¿« ƒ≥Ω¨¿ßƒ°∏¶ ∞≥º±
//				aiProcess_RemoveRedundantMaterials |    // ¡ﬂ∫πµ» ∏≈≈Õ∏ÆæÛ ¡¶∞≈
//				aiProcess_GenUVCoords |                    // ±∏«¸, ø¯≈Î«¸, ªÛ¿⁄ π◊ ∆Ú∏È ∏≈«Œ¿ª ¿˚¿˝«— UV∑Œ ∫Ø»Ø
//				aiProcess_TransformUVCoords |            // UV ∫Ø»Ø √≥∏Æ±‚ (Ω∫ƒ…¿œ∏µ, ∫Ø»Ø...)
//				aiProcess_FindInstances |                // ¿ŒΩ∫≈œΩ∫µ» ∏≈Ω¨∏¶ ∞Àªˆ«œø© «œ≥™¿« ∏∂Ω∫≈Õø° ¥Î«— ¬¸¡∂∑Œ ¡¶∞≈
//				aiProcess_LimitBoneWeights |            // ¡§¡°¥Á ª¿¿« ∞°¡ﬂƒ°∏¶ √÷¥Î 4∞≥∑Œ ¡¶«—
//				aiProcess_OptimizeMeshes |                // ∞°¥…«— ∞ÊøÏ ¿€¿∫ ∏≈Ω¨∏¶ ¡∂¿Œ
//				aiProcess_GenSmoothNormals |            // ∫ŒµÂ∑ØøÓ ≥Î∏ª∫§≈Õ(π˝º±∫§≈Õ) ª˝º∫
//				aiProcess_SplitLargeMeshes |            // ∞≈¥Î«— «œ≥™¿« ∏≈Ω¨∏¶ «œ¿ß∏≈Ω¨µÈ∑Œ ∫–»∞(≥™¥Æ)
//				aiProcess_Triangulate |                    // 3∞≥ ¿ÃªÛ¿« ∏º≠∏Æ∏¶ ∞°¡¯ ¥Ÿ∞¢«¸ ∏È¿ª ªÔ∞¢«¸¿∏∑Œ ∏∏µÎ(≥™¥Æ)
//				aiProcess_ConvertToLeftHanded |            // D3D¿« øﬁº’¡¬«•∞Ë∑Œ ∫Ø»Ø
//				aiProcess_SortByPType);                    // ¥‹¿œ≈∏¿‘¿« «¡∏ÆπÃ∆º∫Í∑Œ ±∏º∫µ» '±˙≤˝«—' ∏≈Ω¨∏¶ ∏∏µÎ
//		
//	if (m_pScene) {
...
XMFLOAT4 CHeightMapGridMesh::OnGetColor(int x, int z, void *pContext)
{
	...
	CHeightMapImage *pHeightMapImage = (CHeightMapImage *)pContext;
	XMFLOAT3 xmf3Scale = pHeightMapImage->GetScale();
	XMFLOAT4 xmf4IncidentLightColor(0.9f, 0.8f, 0.4f, 1.0f);	//¡∂∏Ì¿« ªˆªÛ(ºº±‚, π‡±‚)
