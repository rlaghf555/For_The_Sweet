...
//{
//private:
//	const aiScene*					m_pScene;	// ∏µ® ¡§∫∏
//	std::vector<mesh>				m_meshes;	// ∏≈Ω¨ ¡§∫∏
//	std::vector<pair<string, Bone>>	m_Bones;	// ª¿ ¡§∫∏
//	UINT                            m_numVertices;
//	UINT                            m_numMaterial;
//public:
...
class CMesh
>>>>>>> parent of ecc8677... Î™®Îç∏Îç∞Ïù¥ÌÑ∞ assimp Ïù¥Ïö© ÏΩîÎìú Ï∂îÍ∞Ä
{
public:
